...
bot.login("NjAyNjE0ODI5MzA3NTI3MTg4.XTTbAA.khp3t1uG9fZrsAVnsvsN9X0Q5Ng");
...
bot.on("guildMemberAdd", member => {
	...
	bot.on('message', function(message){
		...
		{ 
			let memberRole = message.member.guild.roles.find("name" , "*");
...
-------------------------------`);
		...
		{
			message.channel.send('```|!.help|!.invite|!.discord|```')
			}
		if(message.content === '!.help')
		{
			message.channel.send('```|!.help|!.invite|!.discord|```')
